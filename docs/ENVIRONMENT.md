...
| `PAYMENTS_MODE` | `disabled` | Automated payment gateway. Forced off in production (never enable) |
| `MANUAL_PAYMENTS_ENABLED` | `true` | Manual bKash/Nagad/Bank/Cash. Must stay true in production |
