...
const LAND_BENEFIT_POINTS = [
  "1 Katha land benefit after successful qualification",
  `1 Membership ID = ${formatBdt(STANDARD_ID_VALUE_BDT)}`,
  "Personally sponsor 3 members — mandatory",
  "Successfully complete Level 9",
  "Land allocation and transfer follow applicable documentation and legal requirements",
] as const;
